...
\documentclass[
21pt, % The default document font size, options: 10pt, 11pt, 12pt
...
\thesistitle{Utilizing fuzzy logic to control umnanned surface vessel according to maritime navigation rules} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
